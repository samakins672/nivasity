(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(255, 145, 0, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(255, 145, 0, 0.02)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
      saleGradientBg2.addColorStop(0, 'rgba(159, 166, 178, 0.19)');
      saleGradientBg2.addColorStop(1, 'rgba(159, 166, 178, 0.03)');
      var salesTopData = {
          labels: ["SUN", "MON", "TUE", "WED", "THU",  "FRI", "SAT"],
          datasets: [{
              label: 'This week',
              data: [0, 0, 360, 250, 200, 0, 0],
