    ...
    try {
        ...
        try {
            ...
            if ($tx_exists) {
                ...
                $insertTxSql = "INSERT INTO transactions (ref_id, user_id, amount, charge, profit, refund, status, medium, payment_channel, transaction_context) VALUES ('$tx_ref_esc', $user_id, $total_amount, $charge, $profit, 0, '$status', '$medium', 'gateway', 'purchase')";
