...
if ($row['status'] === 'sold') sendApiError('Cannot delete a listing with active orders', 400);

mysqli_query($conn, "DELETE FROM marketplace_listings WHERE id = $listing_id AND seller_id = $user_id");
sendApiSuccess('Listing deleted');
?>
