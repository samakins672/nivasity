                  ...
                  <?php if ($user_status == 'verified' && $_SESSION['nivas_userRole'] == 'hoc'): ?>
                    <div class="tab-pane fade hide" id="academics" role="tabpanel" aria-labelledby="academics">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="card card-rounded p-3 shadow-sm role-switch-card">
                            <div class="card-header border-0 pb-0">
                              <h4 class="fw-bold mb-1">Academic Role</h4>
                              <p class="role-switch-subtitle mb-0">Switch between Student and HOC/Lecturer from this page when you need the other experience.</p>
                            </div>
                            <div class="card-body pt-3">
                              <div class="role-switch-note mb-4">
                                Once you change this role, your UI will change after refresh. If you switch to Student, this admin page will close and you will return to the student-side interface.
                              </div>
                                ...
                                <div class="row align-items-end">
                                  <div class="col-md-8">
                                    ...
                                    <select id="academic_role" name="role" class="form-control form-control-lg w-100 academic-select" required>
                                      ...
                                      <option value="hoc" selected>HOC / Lecturer</option>
                                    </select>
                                  </div>
