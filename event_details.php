...
if ($event_query && mysqli_num_rows($event_query) > 0) {
  ...
  $event_image = nivasity_asset_url('assets/images/events/' . rawurlencode($event['event_banner']));
  $event_url = nivasity_app_url('event_details.php?event_id=' . urlencode($event_id));
} else {
