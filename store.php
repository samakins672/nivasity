          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="user.html"><i
                ...
                Profile</a>
              <a class="dropdown-item" href="cart.html"><i
                  class="dropdown-item-icon mdi mdi-cart-outline text-primary me-2"></i>
                Cart</a>
            ...
            <div class="col-sm-12">
              <div class="home-tab">
                <div class="d-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <select class="form-control fw-bold w-100 my-sm-0 my-2" name="session" id="session">
                      <option value="0">Session: 2023/2024</option>
                      <option value="0">Session: 2023/2024</option>
                      <option value="0">Session: 2023/2024</option>
                      <option value="0">Session: 2023/2024</option>
                    </select>
